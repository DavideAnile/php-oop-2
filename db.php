...
$dogBall = new Gioco('Palla Galleggiante per Cane', 6 , 'Camon palla galleggiante è un divertente passa tempo per cane che lo farà divertire e tenere in movimento.', $category[0], './img/dogball.webp', 'BALL');
